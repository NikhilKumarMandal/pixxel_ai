...
function BackgroundControls({ project }: any) {
    ...
    const handleImageBackground = async (imageUrl: string, imageId: any) => {
        if (!canvasEditor) return;
    ...
    return (
        <div className="space-y-6 relative h-full">
            ...
            <div className="py-4 border-t border-white/10 bottom-0 w-full">
                <Button
