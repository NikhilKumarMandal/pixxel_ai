...
function generateHeadsort() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            const res = await fetch("/api/generate-headsort", {
                method: "POST",
                body: formData,
            });
        ...
        <div className="p-4 ">
            <div className="max-w-4xl mx-auto space-y-8">
                <div className="text-center space-y-2">
                    <h1 className="text-3xl font-bold tracking-tight">Generate Headsort</h1>
                ...
                <Card className="w-full bg-[#2a2a2a] text-[#a0a0a0]">
                    ...
                    <CardContent className="space-y-6">
                        <div
                            className="relative border-2 border-dashed border-[#a0a0a0] rounded-lg p-8 text-center hover:border-muted-foreground/50 transition-colors"
                            onDrop={handleDrop}
                ...
                <div className="flex justify-center">
                    <Button onClick={handleSubmit} size="lg" disabled={images.length === 0 || loading} className="min-w-32">
                        Generate Headsort
                    </Button>
                </div>
            </div>
...
export default generateHeadsort;