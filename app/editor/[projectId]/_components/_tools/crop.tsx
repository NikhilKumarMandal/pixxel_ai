...
function CropImage() {
    ...
    const [originalProps, setOriginalProps] = useState<FabricImageProps | null>(null);
    ...
    const applyAspectRatio = (ratio: any) => {
        ...
        <div className="space-y-6">
            ...
            {isCropMode && (
                <div className="space-y-3 pt-4 border-t border-white/10">
                    <Button onClick={applyCrop} className="w-full" variant="secondary">
